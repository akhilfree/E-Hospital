...
import Logo2 from './images/logo-mini.svg';
import Face1 from './images/faces/face2.jpg';
import Face2 from './images/faces/face2.jpg';
import Face3 from './images/faces/face2.jpg';
import Face4 from './images/faces/face2.jpg';
import Face5 from './images/faces/face2.jpg';
import Face6 from './images/faces/face2.jpg';
import Face7 from './images/faces/face2.jpg';
import Face8 from './images/faces/face2.jpg';
...
function UserDashboard(){
    return(
        <div className='UserDashboard' style={{backgroundColor: 'white'}}>
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        <div class="navbar-brand-inner-wrapper d-flex justify-content-between align-items-center w-100">
          <a class="navbar-brand brand-logo" href="index.html"><img src={Logo1} alt="logo"/></a>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar" sty>
        <ul class="nav">
          <li class="nav-item">
      ...
      <div class="main-panel" style={{marginLeft: 270}}>
